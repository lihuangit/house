...
<script type="text/javascript">
  ...
  $(function () {
      $("#but").click(function () {
        location.href="${pageContext.request.contextPath}/page/regs.jsp";
      })
  })
</script>
...
<DIV class=box>
<H4>管理用户登录</H4>
<FORM id=user method=post name=user action=/userLogin1>
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
  ...
  <TR>
    ...
    <TD><!-- <input type="password" class="text" name="password" /> --><INPUT 
      id=userpassword class=text type=password name=password><br><span> <h3 style="color: red">${info1}</h3></span> </TD></TR><!--
						<tr>
